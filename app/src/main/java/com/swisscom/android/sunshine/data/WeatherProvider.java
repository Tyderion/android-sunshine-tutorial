package com.swisscom.android.sunshine.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case WEATHER: {
                    affectedRows = db.delete(WeatherContract.WeatherEntry.TABLE_NAME, null, null);
                break;
            }
            case LOCATION: {
                    affectedRows = db.delete(WeatherContract.LocationEntry.TABLE_NAME, null, null);
                break;
            }
            case LOCATION_ID: {
                affectedRows = db.delete(WeatherContract.LocationEntry.TABLE_NAME, " WHERE " + WeatherContract.LocationEntry._ID + " = " + ContentUris.parseId(uri), null);
                break;
            }
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case WEATHER: {
                affectedRows = db.update(WeatherContract.WeatherEntry.TABLE_NAME, values, selection, selectionArgs);
//                affectedRows = db.update(WeatherContract.WeatherEntry.TABLE_NAME, values, " WHERE " + WeatherContract.WeatherEntry._ID + " = " + id, null);
                break;
            }
            case LOCATION: {
                affectedRows = db.update(WeatherContract.LocationEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
            }
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
